...
export class BedLighting {
    ...
    solver;
    uniform;
    constructor(device, solver, uniform){
        this.device = device;
        this.solver = solver;
        this.uniform = uniform;
        this.buffer = device.createBuffer({
            label: 'Bed-space illumination',
            size: solver.byteLength,
